...
8. If the user speaks Hinglish, respond naturally in Hinglish (e.g. "Haan, 3 options mile hain. Sabse affordable 2,499 ka hai. Kya main details bataun?").`;
...
Guidelines:
- "Mujhe running shoes chahiye, 3000 ke andar" -> intent product_search, category "running shoes", maxPrice 3000, language hinglish.
- "Is the black Nike shoe available in size 9?" -> intent inventory_check, size "9", color "black".
- "Haan batao" / "yes, tell me more" after options were offered -> intent product_details.
